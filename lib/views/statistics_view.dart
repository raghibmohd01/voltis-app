              ...
              AnimatedOpacity(
                ...
                CustomCard(
                  child: ExpansionTile(
                    ...
                    children: [
                      const Text('7-day graph data will be aggregated here.', style: TextStyle(color: Colors.white54)),
                      // Placeholder for 7-day chart
                      Container(
                        height: 180,
                        alignment: Alignment.center,
                        child: const Icon(Icons.bar_chart, size: 64, color: Colors.white12),
                      ),
                    ],
                  ),
                ),
                ...
                CustomCard(
                  child: ExpansionTile(
                    ...
                    childrenPadding: const EdgeInsets.all(16),
                    children: [
                      const Text('30-day graph data will be aggregated here.', style: TextStyle(color: Colors.white54)),
                      // Placeholder for 30-day chart
                      Container(
                        height: 180,
                        alignment: Alignment.center,
                        child: const Icon(Icons.show_chart, size: 64, color: Colors.white12),
                      ),
                    ],
                  ),
                ),
